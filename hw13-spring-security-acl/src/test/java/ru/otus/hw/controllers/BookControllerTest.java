...
@WebMvcTest(controllers = BookController.class,
        excludeFilters = @ComponentScan.Filter(
                ...
                classes = {SecurityConfig.class, AclConfig.class} // исключаю конфиги безопасности, т.к. это тестируется в BookControllerSecurityTest
        )
)
@AutoConfigureMockMvc(addFilters = false) // отключаю фильтры, чтобы не получать 401/403
